...
rsync -a \
  ...
  --exclude 'experiments/manual_entry_confirmation_*' \
  --exclude 'experiments/manual_abstention_*' \
  --exclude 'experiments/manual_strong_confirmation_*' \
  --exclude 'experiments/multi_timeframe_kline_*' \
